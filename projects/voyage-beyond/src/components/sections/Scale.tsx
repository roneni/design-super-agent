...
export default function Scale() {
  ...
  const count = useCountUp(400000000000, 3000, inView)
    ...
    >
      ...
      <div
        style={{
          position: 'absolute',
          inset: 0,
          backgroundImage: 'url(/images/scale-cosmos.png)',
      ...
      >
        ...
        >
          <span
            style={{
              ...
              textShadow:
                '0 0 20px rgba(96,208,224,0.6), 0 0 40px rgba(96,208,224,0.3), 0 0 80px rgba(96,208,224,0.15)',
        ...
        <div ref={subRef}>
          ...
          >
            And there are an estimated two trillion galaxies in the observable universe.
          </motion.p>
        </div>
      </div>
    </section>
